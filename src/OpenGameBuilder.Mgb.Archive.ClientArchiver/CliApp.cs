...
public static class CliApp
{
    ...
    private static FrontendArchiveOptions ParseCapture(string[] args)
    {
        ...
        return new FrontendArchiveOptions(
            ...
            HasFlag(values, "retry-replay-errors"),
    ...
    private static Dictionary<string, string?> ParseOptions(string[] args)
    {
        ...
        for (var index = 0; index < args.Length; index++)
        {
            ...
            if (name is "resume" or "replace" or "retry-replay-errors")
            {
                values[name] = null;
                continue;
            }
    ...
    private static void WriteUsage(TextWriter writer)
    {
        ...
        writer.WriteLine("  capture --seeds <seeds.txt> --output <frontend.sqlite> [--work-dir <path>] [--concurrency N] [--resume] [--replace] [--retry-replay-errors]");
        ...
        writer.WriteLine("  exclude https://v2.mygamebuilder.com/");
        writer.WriteLine("  exclude-contains forum");
    }
}
